...
> **IMPORTANT**: Reviewers should check code against project rules:
> - See `../project-rules/code-integrity.md` for zero duplication policy
> - See `../project-rules/documentation-standards.md` for docstring requirements

Include these in review criteria when dispatching code-reviewer.
